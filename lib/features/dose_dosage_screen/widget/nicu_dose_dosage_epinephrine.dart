...
class _AdrenalinFormState extends State<AdrenalinForm> {
  ...
  void _calculateDose() {
    setState(() {
      ...
      if (concentration > 0 && dose > 0 && weight > 0 && dilution > 0) {
        ...
        _result = 'Адреналин: расчетная доза ${calculatedDose.toStringAsFixed(2)} мл развести до $dilution мл. '
      ...
      children: [
        TextField(
          ...
          decoration: const InputDecoration(
            labelText: 'Концентрация Адреналина (%)',
